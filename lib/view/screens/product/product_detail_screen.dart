                  ...
                  children: [
                    Stack(
                      children: [
                        ...
                        Positioned(
                          top: DeviceHelper.statusbarHeight(context) + 10.sp,
                          left: 24.sp,
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              if (thisProduct?.isAvailable == false)
                                Container(
                                  width:
                                      DeviceHelper.screenWidth(context) * 0.22,
                                  decoration:
                                      BoxDecoration(border: Border.all()),
                                  padding: EdgeInsets.all(4.sp),
                                  child: Text(
                                    thisProduct?.slotMessage ?? '',
                                    maxLines: 3,
                              ...
                              else if (thisProduct?.inStock == false)
                                Container(
